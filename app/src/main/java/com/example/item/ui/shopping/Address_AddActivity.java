...
import com.example.item.presenter.AddressCityPresenter;
...
public class Address_AddActivity extends BaseActivity<IAddress.Presenter> implements IAddress.View {
    ...
    private List<AddressCityBean.DataBean> list;
    ...
    private void addcity() {
        ...
        popupWindow = new PopupWindow(view, GridLayout.LayoutParams.MATCH_PARENT, 600);
...
//                            getWindow().setAttributes(lp);
    ...
    protected void initData() {
        presenter=new AddressCityPresenter(this);
    }

    //TODO 省市地址
    @Override
    public void getAddressCityReturn(AddressCityBean addressCityBean) {
