package com.example.item.ui.shopping.adapter;
...
import com.example.item.weight.NumberSelect;

import java.util.List;

public class GoodsAdapter extends BaseAdapter<CarBean.DataBean.CartListBean> {
    ...
    public GoodsAdapter(Context context, List<CarBean.DataBean.CartListBean> data) {
        super(context, data);
    }
